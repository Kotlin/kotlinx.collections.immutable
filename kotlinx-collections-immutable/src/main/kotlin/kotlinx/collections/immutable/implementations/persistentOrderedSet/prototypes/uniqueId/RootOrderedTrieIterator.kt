...
internal open class RootOrderedTrieIterator<E>(node: OrderedTrieNode<E>) : Iterator<E> {
    private val path = mutableListOf(TrieBufferIterator<E>())
...
private class TrieBufferIterator<out E> {
    ...
    fun hasNextElement(): Boolean {
        return hasNextCell() && buffer[index] !is OrderedTrieNode<*>
    }
    ...
    fun currentNode(): OrderedTrieNode<out E> {
        assert(hasNextNode())
