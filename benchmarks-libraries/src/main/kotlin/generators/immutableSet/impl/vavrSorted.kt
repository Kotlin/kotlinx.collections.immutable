        ...
        SetBenchmarkUtils
{
    ...
    override fun setType(E: String): String = "io.vavr.collection.TreeSet<$E>"

    override fun emptyOf(E: String): String = "io.vavr.collection.TreeSet.empty<$E>()"
