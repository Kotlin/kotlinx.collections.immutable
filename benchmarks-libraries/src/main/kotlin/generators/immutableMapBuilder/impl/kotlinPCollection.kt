...
object KotlinPCollectionMapBuilderImplementation: MapBuilderImplementation {
    override val packageName: String
            = "kotlinPCollection.builder"

    override fun type(): String
            = "kotlinx.collections.immutable.PersistentMap.Builder<$mapBuilderKeyType, $mapBuilderValueType>"
    override fun empty(): String
            = "kotlinx.collections.immutable.ImmutableHashMap.emptyOf<$mapBuilderKeyType, $mapBuilderValueType>().builder() as ${type()}"
    ...
    override fun immutableEmpty(): String
            = "kotlinx.collections.immutable.ImmutableHashMap.emptyOf<$mapBuilderKeyType, $mapBuilderValueType>() as kotlinx.collections.immutable.PersistentMap<$mapBuilderKeyType, $mapBuilderValueType>"
