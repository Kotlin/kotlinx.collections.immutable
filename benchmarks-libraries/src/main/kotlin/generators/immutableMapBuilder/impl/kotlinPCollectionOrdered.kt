...
object KotlinPCollectionOrderedMapBuilderImplementation: MapBuilderImplementation {
    override val packageName: String
            = "kotlinPCollectionOrdered.builder"

    override fun type(): String
            = "kotlinx.collections.immutable.PersistentMap.Builder<$mapBuilderKeyType, $mapBuilderValueType>"
    override fun empty(): String
            = "kotlinx.collections.immutable.ImmutableOrderedMap.emptyOf<$mapBuilderKeyType, $mapBuilderValueType>().builder() as ${type()}"
    ...
    override fun immutableEmpty(): String
            = "kotlinx.collections.immutable.ImmutableOrderedMap.emptyOf<$mapBuilderKeyType, $mapBuilderValueType>() as kotlinx.collections.immutable.PersistentMap<$mapBuilderKeyType, $mapBuilderValueType>"
