...
object KotlinPCollectionSetBuilderImplementation: SetBuilderImplementation {
    ...
    override fun empty(): String
            = "kotlinx.collections.immutable.ImmutableHashSet.emptyOf<$setBuilderElementType>().builder() as ${type()}"
    ...
    override fun immutableEmpty(): String
            = "kotlinx.collections.immutable.ImmutableHashSet.emptyOf<$setBuilderElementType>() as kotlinx.collections.immutable.PersistentSet<$setBuilderElementType>"
