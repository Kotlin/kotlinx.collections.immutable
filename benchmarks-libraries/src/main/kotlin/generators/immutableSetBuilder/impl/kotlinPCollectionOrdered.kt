...
object KotlinPCollectionOrderedSetBuilderImplementation: SetBuilderImplementation {
    ...
    override fun empty(): String
            = "kotlinx.collections.immutable.ImmutableOrderedSet.emptyOf<$setBuilderElementType>().builder() as ${type()}"
    ...
    override fun immutableEmpty(): String
            = "kotlinx.collections.immutable.ImmutableOrderedSet.emptyOf<$setBuilderElementType>() as kotlinx.collections.immutable.PersistentSet<$setBuilderElementType>"
