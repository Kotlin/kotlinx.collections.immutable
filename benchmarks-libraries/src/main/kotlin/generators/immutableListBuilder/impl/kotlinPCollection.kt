...
object KotlinPCollectionListBuilderImplementation: ListBuilderImplementation {
    ...
    override fun empty(): String
            = "kotlinx.collections.immutable.ImmutableVectorList.emptyOf<$listBuilderElementType>().builder() as ${type()}"
    ...
    override fun immutableEmpty(): String
            = "kotlinx.collections.immutable.ImmutableVectorList.emptyOf<$listBuilderElementType>() as kotlinx.collections.immutable.PersistentList<$listBuilderElementType>"
