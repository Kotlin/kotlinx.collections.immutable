...
object KotlinPCollectionOrderedMapImplementation: MapImplementation {
    override val packageName: String
            = "kotlinPCollectionOrdered"

    override fun type(): String
            = "kotlinx.collections.immutable.PersistentMap<$mapKeyType, $mapValueType>"
    override fun empty(): String
            = "kotlinx.collections.immutable.ImmutableOrderedMap.emptyOf<$mapKeyType, $mapValueType>() as ${type()}"
