...
package benchmarks.immutableMap.vavrSorted
...
open class Get {
    ...
    private var persistentMap = io.vavr.collection.TreeMap.empty<IntWrapper, String>()
...
open class Put {
    ...
    @Benchmark
    fun put(): io.vavr.collection.TreeMap<IntWrapper, String> {
...
open class Remove {
    ...
    @Benchmark
    fun remove(): io.vavr.collection.TreeMap<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): io.vavr.collection.TreeMap<IntWrapper, String> {
    var map = io.vavr.collection.TreeMap.empty<IntWrapper, String>()
    for (key in keys) {
