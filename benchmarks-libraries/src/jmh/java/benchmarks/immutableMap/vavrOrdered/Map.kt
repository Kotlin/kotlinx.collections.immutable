...
open class Put {
    ...
    @Benchmark
    fun put(): io.vavr.collection.LinkedHashMap<IntWrapper, String> {
...
open class Remove {
    ...
    @Benchmark
    fun remove(): io.vavr.collection.LinkedHashMap<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): io.vavr.collection.LinkedHashMap<IntWrapper, String> {
