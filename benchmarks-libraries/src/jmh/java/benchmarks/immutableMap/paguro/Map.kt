...
open class Put {
    ...
    @Benchmark
    fun put(): org.organicdesign.fp.collections.PersistentHashMap<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): org.organicdesign.fp.collections.PersistentHashMap<IntWrapper, String> {
