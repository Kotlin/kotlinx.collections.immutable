...
open class Get {
    ...
    private var persistentMap = cyclops.data.HashMap.empty<IntWrapper, String>()
...
open class Put {
    ...
    @Benchmark
    fun put(): cyclops.data.HashMap<IntWrapper, String> {
...
open class Remove {
    ...
    @Benchmark
    fun remove(): cyclops.data.HashMap<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): cyclops.data.HashMap<IntWrapper, String> {
    var map = cyclops.data.HashMap.empty<IntWrapper, String>()
    for (key in keys) {
