...
open class Put {
    ...
    @Benchmark
    fun put(): org.organicdesign.fp.collections.PersistentTreeMap<IntWrapper, String> {
...
open class Remove {
    ...
    @Benchmark
    fun remove(): org.organicdesign.fp.collections.PersistentTreeMap<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): org.organicdesign.fp.collections.PersistentTreeMap<IntWrapper, String> {
