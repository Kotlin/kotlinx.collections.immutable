...
package benchmarks.immutableMap.kotlinPCollectionOrdered
...
open class Get {
    ...
    private var persistentMap = kotlinx.collections.immutable.ImmutableOrderedMap.emptyOf<IntWrapper, String>() as kotlinx.collections.immutable.PersistentMap<IntWrapper, String>
...
open class Put {
    ...
    @Benchmark
    fun put(): kotlinx.collections.immutable.PersistentMap<IntWrapper, String> {
...
open class Remove {
    ...
    @Benchmark
    fun remove(): kotlinx.collections.immutable.PersistentMap<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): kotlinx.collections.immutable.PersistentMap<IntWrapper, String> {
    var map = kotlinx.collections.immutable.ImmutableOrderedMap.emptyOf<IntWrapper, String>() as kotlinx.collections.immutable.PersistentMap<IntWrapper, String>
    for (key in keys) {
