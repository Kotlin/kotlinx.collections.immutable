...
package benchmarks.immutableMap.kotlinPCollectionOrdered.builder
...
open class Get {
    ...
    private var builder = kotlinx.collections.immutable.ImmutableOrderedMap.emptyOf<IntWrapper, String>().builder() as kotlinx.collections.immutable.PersistentMap.Builder<IntWrapper, String>
...
open class Put {
    ...
    @Benchmark
    fun put(): kotlinx.collections.immutable.PersistentMap.Builder<IntWrapper, String> {
