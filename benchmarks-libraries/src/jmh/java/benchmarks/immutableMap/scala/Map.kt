...
open class Get {
    ...
    private var persistentMap = scala.collection.immutable.`HashMap$`.`MODULE$`.empty<IntWrapper, String>()
...
open class Put {
    ...
    @Benchmark
    fun put(): scala.collection.immutable.HashMap<IntWrapper, String> {
...
open class Remove {
    ...
    @Benchmark
    fun remove(): scala.collection.immutable.HashMap<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): scala.collection.immutable.HashMap<IntWrapper, String> {
    var map = scala.collection.immutable.`HashMap$`.`MODULE$`.empty<IntWrapper, String>()
    for (key in keys) {
