...
package benchmarks.immutableMap.kotlinPCollection
...
open class Get {
    ...
    private var persistentMap = kotlinx.collections.immutable.ImmutableHashMap.emptyOf<IntWrapper, String>() as kotlinx.collections.immutable.PersistentMap<IntWrapper, String>
...
private fun persistentMapPut(keys: List<IntWrapper>): kotlinx.collections.immutable.PersistentMap<IntWrapper, String> {
    var map = kotlinx.collections.immutable.ImmutableHashMap.emptyOf<IntWrapper, String>() as kotlinx.collections.immutable.PersistentMap<IntWrapper, String>
    for (key in keys) {
