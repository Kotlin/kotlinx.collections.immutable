...
package benchmarks.immutableMap.kotlinPCollection.builder
...
open class Get {
    ...
    private var builder = kotlinx.collections.immutable.ImmutableHashMap.emptyOf<IntWrapper, String>().builder() as kotlinx.collections.immutable.PersistentMap.Builder<IntWrapper, String>
