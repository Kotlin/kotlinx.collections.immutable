...
open class Get {
    ...
    private var persistentMap = cyclops.data.TrieMap.empty<IntWrapper, String>()
...
open class Put {
    ...
    @Benchmark
    fun put(): cyclops.data.TrieMap<IntWrapper, String> {
...
open class Remove {
    ...
    @Benchmark
    fun remove(): cyclops.data.TrieMap<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): cyclops.data.TrieMap<IntWrapper, String> {
    var map = cyclops.data.TrieMap.empty<IntWrapper, String>()
    for (key in keys) {
