...
open class Get {
    ...
    private var persistentMap = io.usethesource.capsule.core.PersistentTrieMap.of<IntWrapper, String>()
...
open class Put {
    ...
    @Benchmark
    fun put(): io.usethesource.capsule.Map.Immutable<IntWrapper, String> {
...
open class Remove {
    ...
    @Benchmark
    fun remove(): io.usethesource.capsule.Map.Immutable<IntWrapper, String> {
...
private fun persistentMapPut(keys: List<IntWrapper>): io.usethesource.capsule.Map.Immutable<IntWrapper, String> {
