...
package benchmarks.immutableSet.vavr
...
open class Add {
    ...
    @Benchmark
    fun add(): io.vavr.collection.HashSet<IntWrapper> {
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var persistentSet = io.vavr.collection.HashSet.empty<IntWrapper>()
...
open class Remove {
    ...
    @Benchmark
    fun remove(): io.vavr.collection.HashSet<IntWrapper> {
...
private fun persistentSetAdd(elements: List<IntWrapper>): io.vavr.collection.HashSet<IntWrapper> {
    var set = io.vavr.collection.HashSet.empty<IntWrapper>()
