...
open class Add {
    ...
    @Benchmark
    fun add(): cyclops.data.HashSet<IntWrapper> {
...
private fun persistentSetAdd(elements: List<IntWrapper>): cyclops.data.HashSet<IntWrapper> {
    var set = cyclops.data.HashSet.empty<IntWrapper>()
