...
package benchmarks.immutableSet.vavrSorted
...
open class Add {
    ...
    @Benchmark
    fun add(): io.vavr.collection.TreeSet<IntWrapper> {
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var persistentSet = io.vavr.collection.TreeSet.empty<IntWrapper>()
...
open class Remove {
    ...
    @Benchmark
    fun remove(): io.vavr.collection.TreeSet<IntWrapper> {
...
private fun persistentSetAdd(elements: List<IntWrapper>): io.vavr.collection.TreeSet<IntWrapper> {
    var set = io.vavr.collection.TreeSet.empty<IntWrapper>()
