...
package benchmarks.immutableSet.kotlinPCollection
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var persistentSet = kotlinx.collections.immutable.ImmutableHashSet.emptyOf<IntWrapper>() as kotlinx.collections.immutable.PersistentSet<IntWrapper>
