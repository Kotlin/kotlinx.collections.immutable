...
package benchmarks.immutableSet.kotlinPCollection.builder
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var builder = kotlinx.collections.immutable.ImmutableHashSet.emptyOf<IntWrapper>().builder() as kotlinx.collections.immutable.PersistentSet.Builder<IntWrapper>
...
private fun persistentSetBuilderAdd(
    ...
    var set = kotlinx.collections.immutable.ImmutableHashSet.emptyOf<IntWrapper>() as kotlinx.collections.immutable.PersistentSet<IntWrapper>
