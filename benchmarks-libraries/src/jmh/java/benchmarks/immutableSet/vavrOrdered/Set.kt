...
package benchmarks.immutableSet.vavrOrdered
...
open class Add {
    ...
    @Benchmark
    fun add(): io.vavr.collection.LinkedHashSet<IntWrapper> {
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var persistentSet = io.vavr.collection.LinkedHashSet.empty<IntWrapper>()
...
open class Remove {
    ...
    @Benchmark
    fun remove(): io.vavr.collection.LinkedHashSet<IntWrapper> {
...
private fun persistentSetAdd(elements: List<IntWrapper>): io.vavr.collection.LinkedHashSet<IntWrapper> {
    var set = io.vavr.collection.LinkedHashSet.empty<IntWrapper>()
