...
package benchmarks.immutableSet.kotlinPCollectionOrdered.builder
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var builder = kotlinx.collections.immutable.ImmutableOrderedSet.emptyOf<IntWrapper>().builder() as kotlinx.collections.immutable.PersistentSet.Builder<IntWrapper>
