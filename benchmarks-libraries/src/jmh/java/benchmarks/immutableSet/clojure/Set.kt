...
package benchmarks.immutableSet.clojure
...
open class Add {
    ...
    @Benchmark
    fun add(): clojure.lang.PersistentHashSet {
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var persistentSet = clojure.lang.PersistentHashSet.EMPTY
...
open class Remove {
    ...
    @Benchmark
    fun remove(): clojure.lang.PersistentHashSet {
        var set = persistentSet
        repeat(times = size) { index ->
            set = set.disjoin(elements[index]) as clojure.lang.PersistentHashSet
        }
        return set
    }
}
...
private fun persistentSetAdd(elements: List<IntWrapper>): clojure.lang.PersistentHashSet {
    var set = clojure.lang.PersistentHashSet.EMPTY
    for (element in elements) {
        set = set.cons(element) as clojure.lang.PersistentHashSet
    }
    return set
}
