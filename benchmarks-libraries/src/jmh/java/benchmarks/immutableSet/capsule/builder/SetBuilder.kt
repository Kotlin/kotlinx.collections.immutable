...
open class Add {
    ...
    @Benchmark
    fun add(): io.usethesource.capsule.Set.Transient<IntWrapper> {
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var builder = io.usethesource.capsule.core.PersistentTrieSet.of<IntWrapper>().asTransient()
