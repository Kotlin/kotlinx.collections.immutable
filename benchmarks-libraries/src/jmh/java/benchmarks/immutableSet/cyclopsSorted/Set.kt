...
open class Add {
    ...
    @Benchmark
    fun add(): cyclops.data.TreeSet<IntWrapper> {
...
private fun persistentSetAdd(elements: List<IntWrapper>): cyclops.data.TreeSet<IntWrapper> {
    var set = cyclops.data.TreeSet.empty<IntWrapper>()
