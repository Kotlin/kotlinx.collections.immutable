...
package benchmarks.immutableSet.cyclopsTrie
...
open class Add {
    ...
    @Benchmark
    fun add(): cyclops.data.TrieSet<IntWrapper> {
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var persistentSet = cyclops.data.TrieSet.empty<IntWrapper>()
...
open class Remove {
    ...
    @Benchmark
    fun remove(): cyclops.data.TrieSet<IntWrapper> {
...
private fun persistentSetAdd(elements: List<IntWrapper>): cyclops.data.TrieSet<IntWrapper> {
    var set = cyclops.data.TrieSet.empty<IntWrapper>()
