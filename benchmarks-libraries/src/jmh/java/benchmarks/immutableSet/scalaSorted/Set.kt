...
open class Add {
    ...
    @Benchmark
    fun add(): scala.collection.immutable.TreeSet<IntWrapper> {
...
open class Contains {
    ...
    private var elements = listOf<IntWrapper>()
    private var persistentSet = scala.collection.immutable.TreeSet(scala.math.Ordering.comparatorToOrdering(Comparator.naturalOrder<IntWrapper>()))
...
open class Remove {
    ...
    @Benchmark
    fun remove(): scala.collection.immutable.TreeSet<IntWrapper> {
...
private fun persistentSetAdd(elements: List<IntWrapper>): scala.collection.immutable.TreeSet<IntWrapper> {
