...
package benchmarks.immutableList.kotlinPCollection
...
open class Get {
    ...
    private var persistentList = kotlinx.collections.immutable.ImmutableVectorList.emptyOf<String>() as kotlinx.collections.immutable.PersistentList<String>
