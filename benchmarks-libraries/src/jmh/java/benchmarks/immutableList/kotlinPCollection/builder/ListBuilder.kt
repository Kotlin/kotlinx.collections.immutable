...
package benchmarks.immutableList.kotlinPCollection.builder
...
open class Get {
    ...
    private var builder: kotlinx.collections.immutable.PersistentList.Builder<String> = kotlinx.collections.immutable.ImmutableVectorList.emptyOf<String>().builder() as kotlinx.collections.immutable.PersistentList.Builder<String>
...
open class Iterate {
    ...
    private var builder = kotlinx.collections.immutable.ImmutableVectorList.emptyOf<String>().builder() as kotlinx.collections.immutable.PersistentList.Builder<String>
...
private fun persistentListBuilderAdd(size: Int, immutablePercentage: Double): kotlinx.collections.immutable.PersistentList.Builder<String> {
    ...
    var list = kotlinx.collections.immutable.ImmutableVectorList.emptyOf<String>() as kotlinx.collections.immutable.PersistentList<String>
