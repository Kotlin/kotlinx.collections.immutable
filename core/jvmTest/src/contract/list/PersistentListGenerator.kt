...
class PersistentListGenerator {
    object PList {
        ...
        object AddAll : TestStringListGenerator() {
            override fun create(elements: Array<out String>): List<String> {
                return emptyPersistentList<String>().addAll(elements.toList())
            }
        }

        object AddEach : TestStringListGenerator() {
            override fun create(elements: Array<out String>): List<String> {
                return elements.fold(emptyPersistentList()) { list, element -> list.add(element) }
            }
        }

        object MutateAddAll : TestStringListGenerator() {
            override fun create(elements: Array<out String>): List<String> {
                return emptyPersistentList<String>().mutate { it.addAll(elements.toList()) }
            }
        }

        object MutateAddEach : TestStringListGenerator() {
            override fun create(elements: Array<out String>): List<String> {
                return emptyPersistentList<String>().mutate { list -> elements.forEach { list.add(it) } }
            }
        }

        object HeadSubList : TestStringListGenerator() {
            override fun create(elements: Array<out String>): List<String> {
                return emptyPersistentList<String>()
        ...
        object Builder {
            ...
            object AddAll : TestStringListGenerator() {
                override fun create(elements: Array<out String>): MutableList<String> {
                    return emptyPersistentList<String>().builder().apply { this.addAll(elements.toList()) }
                }
            }

            object AddEach : TestStringListGenerator() {
                override fun create(elements: Array<out String>): MutableList<String> {
                    return emptyPersistentList<String>().builder().apply { elements.forEach { this.add(it) } }
                }
            }
            ...
            object HeadSubList : TestStringListGenerator() {
                override fun create(elements: Array<out String>): MutableList<String> {
                    return emptyPersistentList<String>().builder()
