    ...
    object HashMap {
        object Of : TestStringMapGenerator() {
            override fun create(entries: Array<out Map.Entry<String, String>>): Map<String, String> {
                return persistentUnorderedMapOf(*entries.map { it.key to it.value }.toTypedArray())
            }
        }
        ...
        object PutAll : TestStringMapGenerator() {
            override fun create(entries: Array<out Map.Entry<String, String>>): Map<String, String> {
                ...
                return persistentUnorderedMapOf<String, String>().puttingAll(map)
            }
        }

        object PutEach : TestStringMapGenerator() {
            override fun create(entries: Array<out Map.Entry<String, String>>): Map<String, String> {
                return entries.fold(persistentUnorderedMapOf()) { map, entry -> map.putting(entry.key, entry.value) }
            }
        }
        ...
        object MutatePutAll : TestStringMapGenerator() {
            override fun create(entries: Array<out Map.Entry<String, String>>): Map<String, String> {
                val map = mutableMapOf<String, String>().apply { entries.forEach { this[it.key] = it.value } }
                return persistentUnorderedMapOf<String, String>().mutate { it.putAll(map) }
            }
        }

        object MutatePutEach : TestStringMapGenerator() {
            override fun create(entries: Array<out Map.Entry<String, String>>): Map<String, String> {
                return persistentUnorderedMapOf<String, String>().mutate { builder -> entries.forEach { builder[it.key] = it.value } }
            }
        }
        ...
        object Builder {
            object Of : TestStringMapGenerator() {
                override fun create(entries: Array<out Map.Entry<String, String>>): MutableMap<String, String> {
                    return persistentUnorderedMapOf(*entries.map { it.key to it.value }.toTypedArray()).builder()
                }
            }
            ...
            object PutAll : TestStringMapGenerator() {
                override fun create(entries: Array<out Map.Entry<String, String>>): MutableMap<String, String> {
                    val map = mutableMapOf<String, String>().apply { entries.forEach { this[it.key] = it.value } }
                    return persistentUnorderedMapOf<String, String>().builder().apply { putAll(map) }
                }
            }

            object PutEach : TestStringMapGenerator() {
                override fun create(entries: Array<out Map.Entry<String, String>>): MutableMap<String, String> {
                    return persistentUnorderedMapOf<String, String>().builder().apply { entries.forEach { this[it.key] = it.value } }
                }
            }
        }
    }
