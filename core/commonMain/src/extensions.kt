 ...
 */
public inline operator fun <E> PersistentCollection<E>.plus(element: E): PersistentCollection<E> = copyingAdd(element)
 ...
 */
public inline operator fun <E> PersistentList<E>.plus(element: E): PersistentList<E> = copyingAdd(element)
 ...
 */
public inline operator fun <E> PersistentSet<E>.plus(element: E): PersistentSet<E> = copyingAdd(element)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
public inline operator fun <K, V> PersistentMap<out K, V>.plus(pairs: Iterable<Pair<K, V>>): PersistentMap<K, V> = copyingPutAll(pairs)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
public inline operator fun <K, V> PersistentMap<out K, V>.plus(pairs: Array<out Pair<K, V>>): PersistentMap<K, V> = copyingPutAll(pairs)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
public inline operator fun <K, V> PersistentMap<out K, V>.plus(pairs: Sequence<Pair<K, V>>): PersistentMap<K, V> = copyingPutAll(pairs)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
public inline operator fun <K, V> PersistentMap<out K, V>.plus(map: Map<out K, V>): PersistentMap<K, V> = copyingPutAll(map)
 ...
 */
@Suppress("UNCHECKED_CAST")
public fun <K, V> PersistentMap<out K, V>.copyingPutAll(map: Map<out K, V>): PersistentMap<K, V> =
        (this as PersistentMap<K, V>).copyingPutAll(map)

/**
 * See [copyingPutAll].
 */
@Deprecated("Use copyingPutAll() instead.", ReplaceWith("copyingPutAll(map)"))
@Suppress("UNCHECKED_CAST")
public fun <K, V> PersistentMap<out K, V>.putAll(map: Map<out K, V>): PersistentMap<K, V> = copyingPutAll(map)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
public fun <K, V> PersistentMap<out K, V>.copyingPutAll(pairs: Iterable<Pair<K, V>>): PersistentMap<K, V>
        = mutate { it.putAll(pairs) }

/**
 * See [copyingPutAll].
 */
@Deprecated("Use copyingPutAll() instead.", ReplaceWith("copyingPutAll(pairs)"))
public fun <K, V> PersistentMap<out K, V>.putAll(pairs: Iterable<Pair<K, V>>): PersistentMap<K, V> = copyingPutAll(pairs)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
public fun <K, V> PersistentMap<out K, V>.copyingPutAll(pairs: Array<out Pair<K, V>>): PersistentMap<K, V>
        = mutate { it.putAll(pairs) }
 ...
 */
@Deprecated("Use copyingPutAll() instead.", ReplaceWith("copyingPutAll(pairs)"))
public fun <K, V> PersistentMap<out K, V>.putAll(pairs: Array<out Pair<K, V>>): PersistentMap<K, V> = copyingPutAll(pairs)
 ...
 * or this instance if no modifications were made in the result of this operation.
 */
public fun <K, V> PersistentMap<out K, V>.copyingPutAll(pairs: Sequence<Pair<K, V>>): PersistentMap<K, V>
        = mutate { it.putAll(pairs) }
 ...
 */
@Deprecated("Use copyingPutAll() instead.", ReplaceWith("copyingPutAll(pairs)"))
public fun <K, V> PersistentMap<out K, V>.putAll(pairs: Sequence<Pair<K, V>>): PersistentMap<K, V> = copyingPutAll(pairs)
