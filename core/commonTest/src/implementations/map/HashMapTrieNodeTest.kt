...
class HashMapTrieNodeTest {
    ...
    fun addSingle() {
        ...
        map = map.copyingRemove(wrapper1)
    ...
    fun canonicalization() {
        ...
        val map = PersistentHashMap.emptyOf<IntWrapper, Int>().copyingPut(wrapper1, 1).copyingPut(wrapper33, 33)
        ...
        map.copyingRemove(wrapper1).node.accept { node: TrieNode<IntWrapper, Int>, shift: Int, hash: Int, dataMap: Int, nodeMap: Int ->
            assertEquals(0, shift)
            assertEquals(0, hash)
        ...
        testEmptyMap(map.copyingRemove(wrapper1).copyingRemove(wrapper33))
    }
    ...
    fun canonicalization1() {
        ...
        val map = PersistentHashMap.emptyOf<IntWrapper, Int>().copyingPut(wrapper1, 1).copyingPut(wrapper33, 33).copyingPut(wrapper1057, 1057)
        ...
        map.copyingRemove(wrapper1057).node.accept { node: TrieNode<IntWrapper, Int>, shift: Int, hash: Int, dataMap: Int, nodeMap: Int ->
            if (shift == 0) {
                assertEquals(0b0, dataMap)
                assertEquals(0b10, nodeMap)
            } else {
    ...
    fun canonicalization2() {
        ...
        map.copyingRemove(wrapper1).copyingRemove(wrapper1057).node.accept { node: TrieNode<IntWrapper, Int>, shift: Int, hash: Int, dataMap: Int, nodeMap: Int ->
            assertEquals(0, shift)
            assertEquals(0, hash)
            assertEquals(0b10, dataMap)
            assertEquals(0b0, nodeMap)
        ...
        testEmptyMap(map.copyingRemove(wrapper1).copyingRemove(wrapper1057).copyingRemove(wrapper33))
    }
    ...
    fun collision() {
        ...
        val map = PersistentHashMap.emptyOf<IntWrapper, Int>().copyingPut(wrapper1, 1).copyingPut(wrapper2, 2)
        ...
        testEmptyMap(map.copyingRemove(wrapper1).copyingRemove(wrapper2))
    }
    ...
    fun collision1() {
        ...
        val map = PersistentHashMap.emptyOf<IntWrapper, Int>().copyingPut(wrapper1, 1).copyingPut(wrapper2, 2).copyingPut(wrapper3, 3)
    ...
    fun collision2() {
        ...
        map.copyingRemove(wrapper3).node.accept { node: TrieNode<IntWrapper, Int>, shift: Int, hash: Int, dataMap: Int, nodeMap: Int ->
            when (shift) {
                in 0..MAX_SHIFT -> {
        ...
        map.copyingRemove(wrapper3).copyingRemove(wrapper1).node.accept { node: TrieNode<IntWrapper, Int>, shift: Int, hash: Int, dataMap: Int, nodeMap: Int ->
            assertEquals(0, shift)
            assertEquals(0, hash)
            assertEquals(0b10, dataMap)
            assertEquals(0b0, nodeMap)
