...
[![KDoc link](https://img.shields.io/badge/API_reference-KDoc-blue)](https://kotlinlang.org/api/kotlinx.collections.immutable/)
...
The library depends on the Kotlin Standard Library of the version at least `2.3.0`.
